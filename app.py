...
if st.session_state.active_ticker:
    ...
    # Run the diagnostics engine on the locked ticker
    ...
    if result is None:
        ...
        with paper_trade_tab:
            ...
            # Form forces Streamlit to package the input fields and button together tightly
...
# Display current holdings persistently at the bottom
